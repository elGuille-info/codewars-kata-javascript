...
multiply = (a, b) => bigInt(a).multiply(b).toArray(10).value.join('')

//compararTextNum("98765", "56894", "5619135910");
let res = "", num1 = "", num2 = "", resOK;
num1 = "98765", num2 = "56894", resOK = "5619135910";
console.log(num1 + " x " + num2);
res = multiply(num1, num2);
console.log("\tResultado: '" + res + "'");
console.log("\tResultado: '" + resOK + "'");

num1 = "9007199254740991", num2 = "9007199254740991";
resOK = "81129638414606663681390495662081";
console.log(num1 + " x " + num2);
res = multiply(num1, num2);
console.log("\tResultado: '" + res + "'");
console.log("\tResultado: '" + resOK + "'");
